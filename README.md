This is an incomplete battle simulator for Pokemon Ruby. It is planned to support every usable move and Pokemon, totaling at most 65,536 for each (and that number includes glitch moves/Pokemon).
